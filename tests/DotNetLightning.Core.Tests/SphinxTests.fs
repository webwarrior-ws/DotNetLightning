    ...
    testList
        ...
        [
            ...
            <| fun _ ->
                ...
                Expect.equal
                    nextPacket0.HMAC
                    ("2bdc5227c8eb8ba5fcfc15cfc2aa578ff208c106646d0652cd289c0a37e445bb"
                     |> hex.DecodeData
                     |> uint256)
                    ""
                ...
                Expect.equal
                    nextPacket1.HMAC
                    ("28430b210c0af631ef80dc8594c08557ce4626bdd3593314624a588cc083a1d9"
                     |> hex.DecodeData
                     |> uint256)
                    ""
                ...
                Expect.equal
                    nextPacket2.HMAC
                    ("4e888d0cc6a90e7f857af18ac858834ac251d0d1c196d198df48a0c5bf816803"
                     |> hex.DecodeData
                     |> uint256)
                    ""
                ...
                Expect.equal
                    nextPacket3.HMAC
                    ("42c10947e06bda75b35ac2a9e38005479a6feac51468712e751c71a1dcf3e31b"
                     |> hex.DecodeData
                     |> uint256)
                    ""

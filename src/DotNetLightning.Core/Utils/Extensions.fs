...
type System.UInt64 with
    ...
    member private this.GetLeadingZerosCount() =
        if this = 0UL then
            8
        elif this &&& 0xffffffffffffff00UL = 0UL then
            7
        elif this &&& 0xffffffffffff0000UL = 0UL then
            6
        elif this &&& 0xffffffffff000000UL = 0UL then
            5
        elif this &&& 0xffffffff00000000UL = 0UL then
            4
        elif this &&& 0xffffff0000000000UL = 0UL then
            3
        elif this &&& 0xffff000000000000UL = 0UL then
            2
        elif this &&& 0xff00000000000000UL = 0UL then
            1
        else
            0

    member this.GetTruncatedBytes() =
        let numZeros = this.GetLeadingZerosCount()
        this.GetBytesBigEndian() |> Array.skip numZeros
...
type System.UInt32 with
    ...
    member private this.GetLeadingZerosCount() =
        if this = 0u then
            4
        elif this &&& 0xffffff00u = 0u then
            3
        elif this &&& 0xffff0000u = 0u then
            2
        elif this &&& 0xff000000u = 0u then
            1
        else
            0
